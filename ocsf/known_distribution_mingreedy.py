...
for l in range(n_budget_sizes):
    if n_budget_sizes == 1:
        ...
        filename_greedy_01 = 'GREEDY-' + str(0.05) + '-' + str(baseline_budgets[l]) + '-mul-6.pckl'
        ...
        filename_greedy_5 = 'MinGREEDY-' + str(0.05) + '-' + str(baseline_budgets[l]) + '-mul-6.pckl'
...
plt.plot(x, MaxDistRequirements_mean_greedy_01, label='0.05-GREEDY', color='saddlebrown', alpha=0.6, linewidth=2.5, marker="D",markersize='5', markeredgewidth='3')
...
plt.plot(x, MaxDistRequirements_mean_greedy_5, color='forestgreen', alpha = 0.6, label = '0.05-MinGREEDY', linewidth=2.5, marker="*", markersize='10', markeredgewidth='2')
...
plt.plot(x, MinDistRequirements_mean_greedy_01, label='0.05-GREEDY', color='saddlebrown', alpha=0.6, linewidth=2.5, marker="D",markersize='5', markeredgewidth='3')
...
plt.plot(x, MinDistRequirements_mean_greedy_5, color='forestgreen', alpha = 0.6, label = '0.05-MinGREEDY', linewidth=2.5, marker="*", markersize='10', markeredgewidth='2')
...
plt.plot(x, SampleComplexity_mean_greedy_01, label='0.05-GREEDY', color='saddlebrown', alpha=0.6, linewidth=2.5, marker="D",markersize='5', markeredgewidth='3')
...
plt.plot(x, SampleComplexity_mean_greedy_5, color='forestgreen', alpha = 0.6, label = '0.05-MinGREEDY', linewidth=2.5, marker="*", markersize='10', markeredgewidth='2')
